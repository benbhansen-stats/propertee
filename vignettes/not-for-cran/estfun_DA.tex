...
\right).
\end{align*}
The linearizations defined above then also satisfy
\begin{align*}
      \left(\begin{array}{c}\tilde{\alpha}_{(n)}\\ \tilde{\tau}_{(n)} \end{array}\right)
    \defeq& \left(\begin{array}{c}\alpha_{(n)}\\
                    \tau_{(n)} \end{array}\right)
...
\right)\\
    \\
               &=\left(\begin{array}{c}\alpha_{(n)}\\
                         \tau_{(n)} \end{array}\right) +
    \tilde{A}_{22}^{-1}(\alpha_{(n)}, \tau_{(n)})\times \\
    & \left[
                 n^{-1}\sum_{j\in \bigcup
                 \mathcal{Q}}\psi(\vec{Z}_{j};
                 \tau_{(n)},\beta_{(n)} ) - \tilde{A}_{21}(\beta_{(n)}) {A}_{11}^{-1}(\beta_{(n)})n_{\mathcal{C}}^{-1}\sum_{i\in \bigcup \mathcal{C}}\phi(\vec{Z}_{i}; \beta_{(n)})\right].
\end{align*}
...
\begin{align}
  \operatorname{Cov}(\hat\tau) \approx& \tilde{A}_{22}^{-1}\{n^{-1} M_{22} -
                                 ...
                                 n_C^{-1}\tilde{A}_{21}A_{11}^{-1}M_{11}A_{11}^{-t}\tilde{A}_{21}^{t}\}\tilde{A}_{22}^{-1}\nonumber
  \\
                               &= n^{-1}\tilde{A}_{22}^{-1}\{
                                 M_{22} -
                                 \frac{n^{1/2}}{n_{\mathcal{C}}^{1/2}}[M_{21}A_{11}^{-t}\tilde{A}_{21}^t
                                 + \tilde{A}_{21}A_{11}^{-1}M_{12}] +
                                 \frac{n}{n_C}\tilde{A}_{21}A_{11}^{-1}M_{11}A_{11}^{-t}\tilde{A}_{21}^{t}\}\tilde{A}_{22}^{-1}
                                . \label{eq:6}
\end{align}
...
$A_{21}(\beta)$ as given in \eqref{eq:13}. 
  ...
  \paragraph{${A}_{21}$ and ${A}_{22}$ as rescalings  for numerical
    stability of $\tilde{A}_{21}$ and $\tilde{A}_{22}$.}
  ...
  appropriate. Since ${A}_{21} = (n/n_{\mathcal{Q}}) \tilde{A}_{21}$ and
  ${A}_{22} = (n/n_{\mathcal{Q}})\tilde{A}_{22}$, one has $\tilde{A}_{22}^{-1}\tilde{A}_{21} =
  A_{22}^{-1}A_{21}$.   As a result, in parallel with \eqref{eq:6} we
  ...
  \\
                               &= n^{-1}A_{22}^{-1}\{
                                ...
                                . 
\end{align*}
In computations we may combine $\psi$-\texttt{estfun}'s of dimension
$n$ with $\hat{A}_{21}$ and $\hat{A}_{22}$ that have been scaled by
$n_{\mathcal{Q}}$, as opposed to $n$.
