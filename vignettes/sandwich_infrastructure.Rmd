...
classDiagram
  ...
  VeganLayerKit <|-- PreVeganLayerGLM
  PreVeganLayerGLM: +integer na.action
  PreVeganLayerGLM: +terms terms
  PreVeganLayerGLM: +as.VeganLayer(preobj)
  PreVeganLayerGLM: +as.SandwichLayer(preobj)

  VeganLayer: +character keys
  VeganLayer: +double .Data
  VeganLayer: +double prediction_gradient
  VeganLayer: +add_meat()

  SandwichLayer: +character keys
  SandwichLayer: +double meat_matrix
