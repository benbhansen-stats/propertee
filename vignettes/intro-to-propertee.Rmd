...
Bernoulli randomization of students, separately by school.
Accordingly, experimental blocks are given by the `schoolidk` variable.
...
use something like `block(districtid, schoolidk)` in the `_spec` function.
