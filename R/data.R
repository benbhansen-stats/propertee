...
#' @title GV data
#' 
#' @description This dataset contains a 10% random sample of individuals from each system cable cluster. 
#' It specifically includes matched pairs 1–3, which correspond to 7 out of the 85 system cables. 
