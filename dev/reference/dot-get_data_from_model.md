...
([`ate()`](https://benbhansen-stats.github.io/propertee/dev/reference/WeightCreators.md)/[`ett()`](https://benbhansen-stats.github.io/propertee/dev/reference/WeightCreators.md)/[`cov_adj()`](https://benbhansen-stats.github.io/propertee/dev/reference/cov_adj.md)/[`assigned()`](https://benbhansen-stats.github.io/propertee/dev/reference/AssignedAliases.md))
...
use cases
([`ate()`](https://benbhansen-stats.github.io/propertee/dev/reference/WeightCreators.md)/[`ett()`](https://benbhansen-stats.github.io/propertee/dev/reference/WeightCreators.md)
and
